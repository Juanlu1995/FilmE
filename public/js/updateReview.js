...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_izimodal_js_iziModal__ = __webpack_require__(11);
...
$(".modal").iziModal({
    ...
    onClosing: function onClosing() {
        ...
        var rute = '/reviewAJAX/' + review;
        axios.get(rute).then(function (response) {
            var title = response.data.title;
            var content = response.data.content;
            var rating = '<span class="text-danger">Rating: </span> ' + response.data.rating;
