            ...
            @foreach($row as $contribute)
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <p class="card-text">Birth date: <span class="text-danger">{{ $contribute->birth_date}}</span></p>
                        <p class="card-text">Nationality: <span class="text-danger">{{ $contribute->nationality->name}}</span></p>
                    </div>
                </div>
