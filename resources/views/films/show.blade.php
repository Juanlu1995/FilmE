...
@push('scripts')
    ...
    <script src="{{asset('js/createReview.js')}}" defer></script>
@endpush
            ...
            <div class="text-center mt-3 ml-1">
                ...
                @auth()
                    <div class="text-center">
                        <div class="row">
                            <button id="createReview" class="btn btn-outline-primary">
                        ...
                        <div class="row" id="formCreateReview" style="display: none">
                            <form action="/createreview/{{$film->id}}" class="col-md-12">
                                <input type="hidden" name="film" id="film" film="{{$film->id}}">
                                <div class="form-group">
                                    <label for="title">title</label>
                                    <input type="text" placeholder="title here" class="form-control" name="title"
                                           id="title">
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea name="content" id="content" cols="30" rows="10"
                                              placeholder="content here" class="form-control"></textarea>
                                </div>

                                <div class="form-group">
                                    <label for="rating">rating</label>
                                    <input type="number" class="form-control" name="rating" id="rating" placeholder="rating here">
                                </div>
