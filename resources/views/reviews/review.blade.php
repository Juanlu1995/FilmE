    ...
    <div class="row">
        <div class="col-lg-4 text-center">
            ...
            @can('update', $review)
                ...
                <button class="btn btn-warning mt-1" id="trigger">
        ...
        <div class="col-lg-8">
            ...
            <div class="row mt-5">
                <div class="col-lg-4"><h4><span class="text-danger">Rating: </span>{{$review->rating}}</h4></div>
    ...
    <div id="modal" class="modal">
        <div class="car">
            ...
            <div class="row px-3">
                ...
                <button class="col-md-6 btn btn-success" id="continue">Update</button>
            </div>
        </div>
    </div>
